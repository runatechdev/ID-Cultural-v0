...
<!--      <li><a class="menu" href="/src/views/pages/public/busqueda.html">Explorar Artistas</a></li>-->
      <li><a class="menu" href="./wiki.php">Wiki de artistas</a></li>
      <li><a class="menu" href="../auth/login.php">Iniciar Sesion</a></li>
      <li><a class="btn" href="../auth/registro.php">Crear cuenta</a></li>
    </ul>
  </nav>
