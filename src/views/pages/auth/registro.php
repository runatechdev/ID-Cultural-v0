...
<body>
    ...
    <section id="paso1" class="formulario-paso1 active animate__animated animate__fadeInDown">
        ...
        <form id="registroForm" method="POST" action="#">
            ...
            <div class="input-group">
                ...
                <input type="text" id="apellido" name="apellido" placeholder="Ej: Pérez" autocomplete="given-name"
                    required>
            </div>
             ...
             <div class="input-group">
               ...
               <div class="input-group">
                ...
                <input type="email" id="confirmarEmail" name="confirmarEmail" placeholder="Repetí tu correo"
              ...
              <div class="input-group">
                ...
                <input type="password" id="confirmarPassword" name="confirmarPassword"
                    placeholder="Repeti tu contraseña" autocomplete="new-password" required>
            </div>
  ...
  <p class="login-link">¿Ya tenés una cuenta? <a href="#">Ingresá</a></p>
    ...
    <section id="paso2" class="formulario-paso2">
        ...
        <form id="interesesForm" method="POST">
